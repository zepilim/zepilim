...
| [LBAW](https://sigarra.up.pt/feup/pt/ucurr_geral.ficha_uc_view?pv_ocorrencia_id=560108) | [Easy Eats](https://github.com/zepilim/lbaw2534) | A full-stack web platform project that brings together database design, backend logic, and frontend presentation in a single application. It focuses on delivering a complete user flow, from data management and application logic to a clean and usable interface. |
| [RCOM](https://sigarra.up.pt/feup/pt/ucurr_geral.ficha_uc_view?pv_ocorrencia_id=560110) | [Project 1](https://github.com/zepilim/RCOM-Project1) | A networking project that explores the fundamentals of reliable communication between systems. It involves working with packet-level data exchange, transport behavior, and the mechanisms needed to move information correctly across a network. |
| [RCOM](https://sigarra.up.pt/feup/pt/ucurr_geral.ficha_uc_view?pv_ocorrencia_id=560110) | [Project 2](https://github.com/zepilim/RCOM-Project2) | A second networking project that builds on the first by tackling more advanced communication behavior and protocol handling. It further develops low-level network concepts through implementation details related to message flow, system interaction, and transmission reliability. |
...
<a href="https://zeppelin-josebreis.netlify.app/">Website</a>
